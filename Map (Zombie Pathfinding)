...
class Map extends JFrame {
  ...
  private class GamePanel extends JPanel {
    ...
    public void paintComponent(Graphics g) {
      ...
      zombie.draw(g);
      if ((zombie.xCord >= 100) && (zombie.yCord >= 500)) { //Replace coordinates with Human coordinates.
        ...
        zombie.yDirection = zombie.speed;
        zombie.move();
      } else if ((zombie.xCord == 100) && (zombie.yCord == 500)) { //Replace with Human hitbox collision.
        zombie.attack();
      }
    }
  }
