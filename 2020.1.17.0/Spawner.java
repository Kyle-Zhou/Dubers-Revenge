class Spawner {
  ...
  public static void addPistol(Human duber) {
    weapons[0] = new Pistol(duber.getxCentre(), duber.getyCentre() - 10, 15, 30, 15);
  }
  
  public static void addShotgun(Human duber) {
    weapons[1] = new Shotgun(duber.getxCentre(), duber.getyCentre() - 9, 20, 16, 8);
  }
  
  public static void addMachinegun(Human duber) {
    weapons[2] = new Machinegun(duber.getxCentre(), duber.getyCentre() - 11, 15, 60, 30);
  }
  
  public static void addRocketLauncher(Human duber) {
    weapons[3] = new RocketLauncher(duber.getxCentre() - 40, duber.getyCentre() - 15, 70, 2, 1);
  }
  
  public static void addFlamethrower(Human duber) {
    weapons[4] = new Flamethrower(duber.getxCentre(), duber.getyCentre() - 8, 10, 200, 100);
  }
  ...
  public void setCurrentMedKit(int medKit){
