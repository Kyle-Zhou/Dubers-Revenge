...
class Game extends JFrame {
  ...
  Game(String title) {
    ...
    spawner = new Spawner(entities, projectiles, obstacles);
    ...
    gamePanel = new GamePanel(duber, spawner, scroll, entities, projectiles, obstacles);
    this.add(new GamePanel(duber, spawner, scroll, entities, projectiles, obstacles));
