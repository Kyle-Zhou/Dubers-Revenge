...
class Game extends JFrame {
  ...
  Game(String title) {
    ...
    gamePanel = new GamePanel(duber, spawner, scroll, entities, projectiles, duber.getHealth());
    this.add(new GamePanel(duber, spawner, scroll, entities, projectiles, duber.getHealth()));
  ...
  public void cursor(){
    ...
    Image image = Toolkit.getDefaultToolkit().getImage("C://Users/Miao/Downloads/CrossHair.png");
