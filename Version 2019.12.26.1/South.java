...
class South extends Wall {
  ...
  South(int xCord, int yCord) {
    ...
    super.setHitbox(new Rectangle(xCord, yCord + (super.geteHeight() / 2), super.geteWidth(), super.geteHeight() / 2));
  }
  ...
  public void draw(Graphics g) {
    ...
    g.drawRect(super.getxCord(), super.getyCord() + (super.geteHeight() / 2), super.geteWidth(), super.geteHeight() / 2);
  }
}