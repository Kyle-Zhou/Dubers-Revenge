...
class HeadUpDisplay {
  ...
  private void loadSprites() {
    try {
      ...
      sprites[15] = ImageIO.read(new File("Ebutton.png"));
  ...
  public void draw(Graphics g, Human duber, Entity[] entities, Shop shop) { //make things less lengthy
    ...
    if (weapons[spawner.getCurrentWeapon()].getClip() <= 0){
      g.drawImage(sprites[14], duber.getxCentre()-5, duber.getyCord()-10, null);
    }
...
//renovate later
  ...
  public void displayBandagePrompt(Graphics g, Human duber){
    g.drawImage(sprites[15], duber.getxCentre()-40, duber.getyCentre() + 30, null);
  }
