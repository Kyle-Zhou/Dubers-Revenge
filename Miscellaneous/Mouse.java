  ...
  public void mousePressed(MouseEvent e) {
    ...
    if (duber != null) {
      ...
      if (shop.getAddedShop() == true){
        ...
        if (shop.getExitButtonHitbox().contains(xCursor, yCursor)){
        ...
        if (shop.getCurrentShop() == 1){
          if (shop.getbuyingButton1Hitbox().contains(xCursor, yCursor)){
          ...
          if (shop.getbuyingButton1Hitbox2().contains(xCursor, yCursor)){
            if (hud.getCurrency() >= 50){
              hud.setCurrency(hud.getCurrency()-50);
          ...
          if (shop.getbuyingButton1Hitbox3().contains(xCursor, yCursor)){
            if (hud.getCurrency() >= 50){
              hud.setCurrency(hud.getCurrency()-50);
          ...
          if (shop.getbuyingButton1Hitbox4().contains(xCursor, yCursor)){
            if (hud.getCurrency() >= 50){
              hud.setCurrency(hud.getCurrency()-50);
