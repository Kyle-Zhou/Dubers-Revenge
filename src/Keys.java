 ...
 * @author Kyle Zhou, Ethan Zhang, Eric Miao
 * Kyle Zhou - Movement, Weapon Switch, and Shop Interactions
 * Ethan Zhang - Holding LMB and Movement Check
 * Eric Miao - Ending Screen Interactions
 **/
...
public class Keys implements KeyListener{
  ...
  public void keyPressed(KeyEvent e) {
    ...
    } else { //display game over screen and wait for button presses
