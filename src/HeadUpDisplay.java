...
class HeadUpDisplay {
  ...
  public void draw(Graphics g, Human duber, Entity[] entities, Shop shop) {
    ...
    g.drawImage(sprites[8], (int)-scroll.getXCamera() + (maxX - 150) - xLock, (int)-scroll.getYCamera() + (maxY - 400) - yLock, null);
   ...
   * @param zombieCounter; the current number of zombies
   */
   ...
   * @return the hitbox of the shop button
   */
