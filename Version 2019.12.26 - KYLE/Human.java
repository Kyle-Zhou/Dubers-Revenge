...
class Human extends Mammal {
  ...
  public void draw(Graphics g) {
    ...
    g.fillRect(super.getxCord()-600, super.getyCord()-300, 100*ratio, 20);
    g.setColor(Color.RED);
    g.fillRect(super.getxCord()-600, super.getyCord()-300, getHealth()*ratio, 20);//not up to scale, you guys change it
    //add an image of heart that indicates the bar is the healthbar
  }
